// src/app/api/admin/games/force_refresh_metadata/route.ts
...
function urlVariants() {
    return [
        `${API_BASE_URL}/games/force_refresh_metadata/`,
        `${API_BASE_URL}/games/force_refresh_metadata`,
    ];
}
...
/** POST /api/admin/games/force_refresh_metadata -> POST {API_BASE_URL}/games/force_refresh_metadata[/] */
export async function POST(_req: NextRequest) {
    ...
    return NextResponse.json(
        { detail: "force_refresh_metadata not allowed upstream (tried with and without trailing slash)" },
        { status: 405 }
    );
}
